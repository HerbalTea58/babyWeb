...
<link rel="stylesheet" href="<%=basePath%>/css/adviseAll.css" type="text/css" />
</head>
<body>
	<div class="top">
	...
	<div class="main">
		<div class="main_left">
			<span class="text1"><strong>等你来回答</strong></span>
		...
		<div class="main_right">
			<span class="tex1"><strong>动态</strong></span>
